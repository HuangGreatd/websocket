...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/yuchuang-backend/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/HuangGreatd\">Juzipi</a>");
        ...
        packageConfig.setParent("com.juzipi");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("Huanglinzhi1+");
        dataSourceConfig.setUrl("jdbc:mysql://43.138.247.98:3306/biyesheji?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
